...
export const translations: Record<Language, Translations> = {
  ...
  mr: {
    ...
    english: "English",
    marathi: "मराठी",
    welcome: "FarmAssist मध्ये आपले स्वागत आहे",
    myCrops: "🪴 माझी पिके",
    myLabor: "👷‍♂️ माझे मजूर",
    ...
    totalLaborCost: "एकूण मजूर खर्च",
    noLaborRecords: "अजून कोणते मजूर रेकॉर्ड नाहीत",
    edit: "संपादित करा",
